...
//任务ID计数器
let taskIdCounter = 1;
//任务的最小堆 [flushPassiveEffects(),performConcurrentWorkOnRoot.bind(null, root),performConcurrentWorkOnRoot.bind(null, root),flushPassiveEffects()]
const taskQueue = []; 
...
function workLoop(startTime) {
  ...
  while (currentTask !== null) {
    ...
    // api performConcurrentWorkOnRoot.bind(null, root)
    // 取出当前的任务中的回调函数 performConcurrentWorkOnRoot.bind(null, root)
